...
public class RestoreRequest
{
    ...
    public int? Days
    {
        ...
        set
        {
            if (value != null && value.Value < 1) throw new ArgumentOutOfRangeException(nameof(this.Days));
            this._days = value;
        }
    }
    ...
    public RestoreTierEnum? EffectiveTier
    {
        get
        {
            ...
            return this.GlacierJobParameters?.Tier;
        }
    }
    ...
    public bool HasUnsupportedRestoreSelectFields
    {
        get
        {
            if (this.AdditionalElements == null || this.AdditionalElements.Length < 1) return false;

            return this.AdditionalElements.Any(e =>
                e != null
