...
public class ListVersionsResult
{
        ...
        string bucketRegion = "us-west-1")
    {
        ...
        if (versions != null) this.Versions = versions;
        if (deleteMarkers != null) this.DeleteMarkers = deleteMarkers;
        this.NextKeyMarker = nextKeyMarker;
        this.NextVersionIdMarker = nextVersionIdMarker;
        this.Delimiter = delimiter;
        if (commonPrefixes != null) this.CommonPrefixes = commonPrefixes;
    ...
    {
        return this.Versions != null && this.Versions.Count > 0;
    }
    ...
    {
        return this.DeleteMarkers != null && this.DeleteMarkers.Count > 0;
    }
    ...
    {
        return !String.IsNullOrEmpty(this.NextKeyMarker);
    }
    ...
    {
        return !String.IsNullOrEmpty(this.NextVersionIdMarker);
    }
